...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  await loadPartial("header", "./geography_components/header.html");
  await loadPartial("footer", "./geography_components/footer.html");
  if (window.location.pathname.includes("quiz-contact.html")) {
    await loadPartial(
      "contact-info",
      "./geography_components/contact-info.html"
    );
  }
  ...
  console.log("Quiz Guess the Country website initialized successfully!");
});
