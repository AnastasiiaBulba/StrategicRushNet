...
function getCurrentPage() {
  ...
  if (path.includes("quiz-news.html")) return "news";
  if (path.includes("quiz-contact.html")) return "contact";
  return "home";
}
                ...
                ${data.howToPlay
                  .map(
                    ...
                    <div class="how-to-item">
                        ...
                        <ul class="how-to-list" style="counter-reset: step-counter;">
                            ${item.steps
                              .map((step) => `<li>${step}</li>`)
                              .join("")}
                        </ul>
      ...
      .map(
        ...
        <div class="news-card">
          <div class="news-image">
            ${
              update.image
                ? `<img src="${update.image}" alt="Geography Quiz Update" class="news-image-photo" style="width:100%;height:auto;object-fit:cover;border-radius:12px;" />`
                : ""
            }
          </div>
          <div class="news-content">
            <span class="news-category updates">Game Update</span>
      ...
      .map(
        ...
        <div class="news-card">
          <div class="news-image">
            ${
              diary.image
                ? `<img src="${diary.image}" alt="Geography Quiz Development" class="news-image-photo" style="width:100%;height:auto;object-fit:cover;border-radius:12px;" />`
                : ""
            }
          </div>
          <div class="news-content">
...
function loadFallbackContent() {
  ...
  const elements = {
    "hero-title": "Quiz Guess the Country",
    "hero-description":
      "Test your world knowledge with this exciting geography quiz! Guess countries by their shapes and outlines in this addictive shape-recognition adventure.",
    "play-now-btn": "Play Now",
    "features-title": "Game Features",
    "how-to-play-title": "How to Play",
    "track-title": "Explore World Regions",
    "track-description":
      "Test your knowledge across different continents and regions with unique challenges and varying difficulty levels.",
